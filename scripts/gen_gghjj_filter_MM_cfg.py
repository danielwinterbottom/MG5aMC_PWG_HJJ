...
# with command line options: Configuration/GenProduction/python/gghjj_fragment_2018_filter.py --python_filename gen_gghjj_filter_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:output.root --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/gghjj_fragment_2018_filter.py nevts:100'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    HepMCFilter = cms.PSet(
        ...
        filterParameters = cms.PSet(
            ...
            HadHadCut = cms.string('Had1.Pt > 33 && Had2.Pt > 33 && Had1.Eta < 2.5 && Had2.Eta < 2.5'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('../X0jj_slc7_amd64_gcc820_CMSSW_10_6_7_X0jj_MM_HTT_v3.tgz'),
